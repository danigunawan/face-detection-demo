...
export default class Math2 {
    ...
    /**
     * Check if the lines intersect w/ each other
     * @param  {Vector2} p1
     * @param  {Vector2} p2
     * @param  {Vector2} p3
     * @param  {Vector2} p4
     * @return {Boolean}
     */
    static isLineIntersecting(p1, p2, p3, p4) {
        return (Math2.getCCW(p1, p3, p4) != Math2.getCCW(p2, p3, p4)) &&
               (Math2.getCCW(p1, p2, p3) != Math2.getCCW(p1, p2, p4));
    }

    /**
     * Get the direction of the change in slope between 2 edges
     * described by the 3 points specified
     * @param  {Vector2} p1
     * @param  {Vector2} p2
     * @param  {Vector2} p3
     * @return {Int}
     */
    static getCCW(p1, p2, p3) {
